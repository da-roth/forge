...
inline void emitRound(asmjit::x86::Assembler& a, asmjit::x86::Vec dst, asmjit::x86::Vec src) {
...
inline void emitFMA(asmjit::x86::Assembler& a,
                    asmjit::x86::Vec dst,
                    asmjit::x86::Vec a_reg,
                    asmjit::x86::Vec b_reg,
                    asmjit::x86::Vec c_reg) {
...
inline void emitConvertDoubleToInt(asmjit::x86::Assembler& a, asmjit::x86::Vec dst, asmjit::x86::Vec src) {
    // vcvtpd2dq converts 4 doubles in YMM to 4 32-bit ints in lower XMM
    // Use xmm() to get the 128-bit view of the destination register
    a.vcvtpd2dq(dst.xmm(), src);
}

// Convert packed 32-bit integers to packed doubles
inline void emitConvertIntToDouble(asmjit::x86::Assembler& a, asmjit::x86::Vec dst, asmjit::x86::Vec src) {
    // vcvtdq2pd converts 4 32-bit ints to 4 doubles
    // Use xmm() to get the 128-bit view of the source register
    a.vcvtdq2pd(dst, src.xmm());
}

// Compare greater than: returns mask
inline void emitCmpGT(asmjit::x86::Assembler& a, asmjit::x86::Vec dst, asmjit::x86::Vec a_reg, asmjit::x86::Vec b_reg) {
...
inline void emitBlend(asmjit::x86::Assembler& a,
                      asmjit::x86::Vec dst,
                      asmjit::x86::Vec true_val,
                      asmjit::x86::Vec false_val,
                      asmjit::x86::Vec mask) {
...
inline void emitBroadcastConstant(asmjit::x86::Assembler& a, asmjit::x86::Vec dst, double value) {
...
inline void emitScaleByPowerOf2(asmjit::x86::Assembler& a,
    ...
    // Use xmm() to get the 128-bit view of the exp_as_int register
    a.vpmovsxdq(tmp1, exp_as_int.xmm());  // Sign extend to 64-bit
