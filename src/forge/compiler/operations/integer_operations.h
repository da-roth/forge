...
/**
 * Handles integer operations: IntConstant, IntAdd, IntSub, IntMul, IntDiv, IntMod, IntNeg,
 * IntCmpLT/LE/GT/GE/EQ/NE, IntIf
...
public:
     ...
     */
    static void generateIntegerOperations(
...
private:
    ...
    static void generateIntConstant(
        asmjit::x86::Assembler& a,
        const forge::core::Node& node,
        forge::core::NodeId nodeId,
        forge::x86::IRegisterAllocator& regState,
    ...
    static void generateIntArithmetic(
        asmjit::x86::Assembler& a,
        const forge::core::Node& node,
        forge::core::NodeId nodeId,
        forge::x86::IRegisterAllocator& regState,
    ...
    static void generateIntComparison(
        asmjit::x86::Assembler& a,
        const forge::core::Node& node,
        forge::core::NodeId nodeId,
        forge::x86::IRegisterAllocator& regState,
